...
const KEYS = {
  /* Избранные калькуляторы и инструменты: заголовок и адрес, по
     полсотни записей максимум. Хранится вместе с остальным прогрессом,
     поэтому отмеченное на телефоне видно и на компьютере. */
  favorites: 8000,
