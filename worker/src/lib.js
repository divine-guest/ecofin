...
/* Текст видит человек, поэтому он объясняет причину и срок, а не
   сообщает о поломке. */
export const PAUSED_AI =
  "ИИ-консультант временно отключён: оформляем уведомление в Роскомнадзор " +
  "о передаче данных за границу. Расчёты, документы и напоминания работают " +
  "как обычно — вернём в ближайшие дни.";
export const PAUSED_TG =
  "Уведомления в Telegram временно отключены: оформляем уведомление " +
  "в Роскомнадзор. Напоминания продолжают приходить на сайте.";
