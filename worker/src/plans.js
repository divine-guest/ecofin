/* ЭкоФин — тарифы и права доступа.
   ...
   Два платных уровня вместо одного и почему цены такие.

   1. «Базовый» за 490 ₽ — примерная цена одного часа работы бухгалтера,
      делённая на четыре. Сравнение идёт не с нулём, а с тем, во что
      обходится одна ошибка: штраф за просроченную декларацию начинается
      от 1 000 ₽. Рядом с 490 старший тариф за 890 выглядит выбором, а не
      препятствием — и человек сравнивает тарифы между собой, а не
...
export const PLANS = {
  free: {
    ...
    perks: [
      "32 калькулятора — сколько угодно раз",
  ...
  basic: {
    id: "basic",
    title: "Базовый",
    price: { month: 490, year: 3990 },
    tagline: "Дешевле часа бухгалтера — и работает весь месяц",
