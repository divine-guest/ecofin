...
const PALETTE = {
  ...
  base() {
    const list = [
      ...
      { kind: "Калькулятор", title: "Налог на квартиру и дом: сколько придёт в квитанции", href: "calc.html", tab: 28 },
      { kind: "Калькулятор", title: "Транспортный налог на машину", href: "calc.html", tab: 29 },
