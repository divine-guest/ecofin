...
/* ============ ЖУРНАЛ СВЕРКИ ============
   ...
   • АУСН: ставки, лимит дохода, число работников, взнос на травматизм;
   • ЕСХН: ставка и порог освобождения от НДС;
   • ОСНО: налог на прибыль, профвычет ИП;
   • НПД: лимит и ставки;
   • налог на имущество физлиц: ставки и вычеты по площади;
   • транспортный налог: ставки и повышающие коэффициенты;
   • выходное пособие при сокращении;
   • классы профессионального риска (травматизм).
