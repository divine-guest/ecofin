...
/* ============ ЖУРНАЛ СВЕРКИ ============
   ...
   • выходное пособие: месяц плюс до двух месяцев на поиск работы;
   • классы профессионального риска: от 0,2% до 8,5%.

   ЕЩЁ НЕ СВЕРЕНО — не считать проверенным:

   • точные ступени госпошлины (см. выше);
   • правовые утверждения в статьях базы знаний: там не числа, а
     нормы, и проверяются они по кодексу, а не поиском по цифрам.
