...
/* ============ ЖУРНАЛ СВЕРКИ ============
   ...
   СООТВЕТСТВУЕТ РЕФОРМЕ, НО ТОЧНЫЕ СТУПЕНИ НЕ ПОДТВЕРЖДЕНЫ:

   • госпошлина в суд (ст. 333.19). Значения соответствуют редакции
     после ФЗ от 08.08.2024 № 259-ФЗ, но справочные сайты до сих пор
     показывают дореформенный текст — по ним же и ошибаются. Ступени
     стоит подтвердить по официальному изданию или у юриста.
   ...
   ЕЩЁ НЕ СВЕРЕНО — не считать проверенным:

   • точные ступени госпошлины (см. выше);
