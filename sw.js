...
const ASSETS = [
  ...
  "404.html",
  "css/style.css?v=9",
  "js/api.js?v=9", "js/app.js?v=9", "js/partners.js?v=9", "js/ai.js?v=9", "js/rates.js?v=9", "js/docscan.js?v=9",
  "js/games.js?v=9", "js/knowledge.js?v=9", "js/templates.js?v=9", "js/courses.js?v=9",
  "js/competencies.js?v=9",
