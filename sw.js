...
const ASSETS = [
  ...
  "404.html",
  "css/style.css?v=8",
  "js/api.js?v=8", "js/app.js?v=8", "js/partners.js?v=8", "js/ai.js?v=8", "js/rates.js?v=8", "js/docscan.js?v=8",
  "js/games.js?v=8", "js/knowledge.js?v=8", "js/templates.js?v=8", "js/courses.js?v=8",
  "js/competencies.js?v=8",
