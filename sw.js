...
const ASSETS = [
  ...
  "404.html",
  "css/style.css?v=6",
  "js/api.js?v=6", "js/app.js?v=6", "js/ai.js?v=6", "js/rates.js?v=6", "js/docscan.js?v=6",
  "js/games.js?v=6", "js/knowledge.js?v=6", "js/templates.js?v=6", "js/courses.js?v=6",
  "js/competencies.js?v=6",
