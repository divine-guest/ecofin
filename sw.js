...
const ASSETS = [
  ...
  "404.html",
  "css/style.css?v=5",
  "js/api.js?v=5", "js/app.js?v=5", "js/ai.js?v=5", "js/rates.js?v=5", "js/docscan.js?v=5",
  "js/games.js?v=5", "js/knowledge.js?v=5", "js/templates.js?v=5", "js/courses.js?v=5",
  "js/competencies.js?v=5",
